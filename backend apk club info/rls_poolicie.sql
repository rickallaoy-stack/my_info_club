-- =========================================================
-- PLATEFORME DU CLUB INFORMATIQUE — POLICIES RLS
-- A exécuter APRES schema.sql
-- =========================================================
...
-- Rôle de l'utilisateur courant (évite de répéter la sous-requête partout)
...
-- (contenu pédagogique : lecture ouverte, écriture admin/formateur)
-- =========================================================
...
-- Un membre ne peut déposer que sa propre remise, pour une activité de sa classe
...
-- Seul un formateur (ou admin) peut modifier le statut d'une remise
...
-- =========================================================
-- PLACEMENT QUIZ (quizzes / questions / options : lecture ouverte)
-- =========================================================
...
-- ATTENTION: accès direct restreint à admin/trainer uniquement. Un membre ne
-- doit JAMAIS pouvoir lire est_correcte avant de répondre — il passe par la
-- RPC public.get_placement_quiz() (voir placement_security.sql) qui ne
-- renvoie jamais ce champ.
...
-- (sans ça, une vue s'exécute avec les droits de son propriétaire,
-- ce qui contournerait toutes les policies ci-dessus)
-- =========================================================
